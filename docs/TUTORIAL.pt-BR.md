...
8. **Fase 7: Servidor e Dashboard**: Inicializa um servidor Express protegido localmente para renderizar o dashboard interativo tridimensional.

---

## 🎮 Interagindo com o Grafo de Conhecimento 3D

Assim que a análise é finalizada, o dashboard carrega um espaço interativo tridimensional:

- **Navegação**:
  - **Botão Esquerdo do Mouse + Arrastar**: Rotaciona o espaço 3D.
