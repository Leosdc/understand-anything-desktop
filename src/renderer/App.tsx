...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    helpP1: "Understand Anything decomposes your code repository into 7 phases of structural and semantic analysis to generate an interactive knowledge graph.",
  ...
  "pt-BR": {
    ...
    helpP1: "O Understand Anything decompõe seu repositório de código em 7 fases de análise estrutural e semântica para gerar um grafo de conhecimento interativo.",
  ...
  es: {
    ...
    helpP1: "Understand Anything descompone su repositorio de código en 7 fases de análisis estructural y semántico para generar un gráfico de conocimiento interactivo.",
  ...
  zh: {
    ...
    helpTitle: "分析是如何工作的？",
    helpP1: "Understand Anything 将您的代码库分解为 7 个结构和语义分析阶段，以生成交互式知识图谱。",
  ...
  ja: {
    title: "Understand Anything Desktop",
    subtitle: "任意のコードベースのインタラクティブな 知識グラフを生成して探索します。",
    provider: "AI プロバイダー",
    model: "AI モデル",
    apiKey: "API キー",
    show: "表示",
